...
from chtxgnn.data import load_fda_drugs, filter_active_drugs
from chtxgnn.mapping import (
    map_fda_drugs_to_drugbank,
    map_fda_indications_to_diseases,
    get_mapping_stats,
    get_indication_mapping_stats,
)
from chtxgnn.predict import find_repurposing_candidates, generate_repurposing_report


def main():
    print("=" * 60)
    print("知識圖譜方法 - Switzerland藥品老藥新用預測")
    print("Vorhersage der Arzneimittelumwidmung in der Schweiz")
    print("=" * 60)
    print()
