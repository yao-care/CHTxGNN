...
import pandas as pd
from chtxgnn.collectors import DrugBundleAggregator
from chtxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from chtxgnn.collectors.drug_bundle import PredictedIndication
    from chtxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from chtxgnn.collectors.drug_bundle import DrugBundle
